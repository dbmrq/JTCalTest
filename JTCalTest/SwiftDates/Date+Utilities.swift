...
// Day {{{3
    ...
    public var startOfDay: Date {
        return Date.sharedCalendar.startOfDay(for: self)
...
// Week {{{3
    ...
    public var nextWeek: Date { return self.offset(.weekOfYear, 1).startOfWeek }
    /// Returns the start of last week of year for user's preferred calendar
    public var lastWeek: Date { return self.offset(.weekOfYear, -1).startOfWeek }
    /// Returns the start of next week of year for user's preferred calendar relative to date
    public static var nextWeek: Date { return Date().offset(.weekOfYear, 1).startOfWeek }
    /// Returns the start of last week of year for user's preferred calendar relative to date
    public static var lastWeek: Date { return Date().offset(.weekOfYear, -1).startOfWeek }
...
// Month {{{3
    ...
    /// Returns a date representing a second before midnight at the end of the month
    public var endOfMonth: Date { return self.nextMonth.offset(.second, -1) }
    ...
    public var nextMonth: Date { return self.offset(.month, 1).startOfMonth }
    /// Returns the start of last month for user's preferred calendar
    public var lastMonth: Date { return self.offset(.month, -1).startOfMonth }
    /// Returns the start of next month for user's preferred calendar relative to date
    public static var nextMonth: Date { return Date().offset(.month, 1).startOfMonth }
    /// Returns the start of last month for user's preferred calendar relative to date
    public static var lastMonth: Date { return Date().offset(.month, -1).startOfMonth }
...
// Year {{{3
    ...
    public var nextYear: Date { return self.offset(.year, 1).startOfYear }
    /// Returns the start of last year for the user's preferred calendar
    public var lastYear: Date { return self.offset(.year, -1).startOfYear }
    /// Returns the start of next year for the user's preferred calendar
    public static var nextYear: Date { return thisYear.offset(.year, 1).startOfYear }
    /// Returns the start of last year for the user's preferred calendar
    public static var lastYear: Date { return thisYear.offset(.year, -1).startOfYear }
